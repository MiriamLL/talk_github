...
# `r text_spec("Git & Github", background = "#1d3557", color = "white", bold = T, font_size=60)`

<br>
<h2>`r text_spec("Miriam Lerma", background = "#264653", color = "white", bold = T)`</h2>

<h3>`r text_spec("October 2021", background = "#0A121F", color = "white", bold = T)`</h3>
...
.pull-left[
Interestingly, the low reproducibility not apply to other scientist but also their **OWN** research. 
...
<h4>`r fa("laptop", fill = "black")`  Machine readable</h4>
<h4>`r fa("user-friends", fill = "black")` Human readable </h4>
<h4>`r fa("robot", fill = "black")`  Plays well with default ordering </h4>

---

## 5.3. Machine readable `r fa("laptop", fill = "black")`

- Use key words 
- No special characters  
- No punctuation
- Use "_" to separate names with more than one word

<br>

**Avoid**
- Using similar key words for files with different contents

---

## 5.4. Human readable `r fa("user-friends", fill = "black")`
...
**Note**
Makes more sense is everything is contained in a folder/project

---

## 5.5. Default ordering `r fa("robot")`
...
my [`r fa("external-link-alt", fill = '#74c69d')`github](https://github.com/MiriamLL/Curso_CIAD/)
and my [`r fa("external-link-alt", fill = '#74c69d')`blog](https://www.miriam-lerma.com/materiales.html)
...
library(fontawesome)
```
<h3>`r fa("home", fill = "#74c69d")`[Home ](https://www.miriam-lerma.com)
]]
